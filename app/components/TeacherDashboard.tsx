...
const fields: Record<Step, { key: string; label: string }[]> = {
  ...
  2: [
    { key: "actualConditions", label: "실제 수업 조건" },
    { key: "responseFormat", label: "AI 응답 형식" },
    { key: "gemPracticeRequest", label: "첫 AI 요청" },
    { key: "method1Name", label: "방법 1" },
    { key: "method1Activity", label: "방법 1 · 학생 활동" },
    { key: "method1Evidence", label: "방법 1 · 확인할 학생 반응" },
    { key: "method1Burden", label: "방법 1 · 시간·부담" },
    { key: "method1Review", label: "방법 1 · 교사 검토" },
    { key: "method2Name", label: "방법 2" },
    { key: "method2Activity", label: "방법 2 · 학생 활동" },
    { key: "method2Evidence", label: "방법 2 · 확인할 학생 반응" },
    { key: "method2Burden", label: "방법 2 · 시간·부담" },
    { key: "method2Review", label: "방법 2 · 교사 검토" },
    { key: "method3Name", label: "방법 3" },
    { key: "method3Activity", label: "방법 3 · 학생 활동" },
    { key: "method3Evidence", label: "방법 3 · 확인할 학생 반응" },
    { key: "method3Burden", label: "방법 3 · 시간·부담" },
    { key: "method3Review", label: "방법 3 · 교사 검토" },
    { key: "newConditions", label: "새로 확인한 수업 운영 조건" },
    { key: "conditionPrompt", label: "조건 반영 추가 요청" },
    { key: "revisedMethod1", label: "수정된 방법 1" },
    { key: "revisedMethod2", label: "수정된 방법 2" },
    { key: "revisedMethod3", label: "수정된 방법 3" },
    { key: "conditionChangeMemo", label: "조건 변경 메모" },
    { key: "evidenceCheck", label: "자료 확인 결과" },
    { key: "selectedMethod", label: "교사가 선택한 방법" },
    { key: "selectionReason", label: "선택한 이유" },
    { key: "teacherRevision", label: "교사가 수정한 내용" },
    { key: "finalMethodReason", label: "최종 방법과 선택 이유" },
...
const lessonOneExtraLabels: Record<string, string> = {
  ...
  method1: "방법 1 이름(이전 형식)",
  method2: "방법 2 이름(이전 형식)",
  method3: "방법 3 이름(이전 형식)",
  method4: "방법 4 이름(이전 형식)",
  method5: "방법 5 이름(이전 형식)",
  finalCheckProblem: "최종 확인: 1차시 수업 문제 반영",
  finalCheckConcrete: "최종 확인: 구체적인 학생 활동",
  finalCheckEvidence: "최종 확인: 학생 반응 기준",
  finalCheckTeacherRevision: "최종 확인: 교사의 확인·선택·수정",
  gameTitle: "체험한 게임",
