...
const allowedKeys: Record<number, Set<string>> = {
  ...
  3: new Set(["gameId", "gameTitle", "playedAt", "studentAction", "feedbackMechanism", "changePlan", "contentTitle", "resultUrl", "contentPlan", "uploadedFileName", "uploadedFileSize", "uploadedFilePath"]),
