...
const allowedKeys: Record<number, Set<string>> = {
  1: new Set([
    ...
    "learningEvidence1", "learningEvidence2", "problemStatement", "problemStatementSource",
  ...
  2: new Set([
    ...
    "finalMethodReason", "finalLessonStage", "finalStudentActivity", "finalStudentEvidence",
    "finalCheckProblem", "finalCheckConcrete", "finalCheckEvidence", "finalCheckTeacherRevision",
  ]),
